...
function handleAddToCart(e){
    ...
    return(
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden h-full border border-gray-200 flex flex-col hover:shadow-xl transition h-56 sm:h-44">
            <div>
            ...
            <div className="h-44 sm:h-40overflow-hidden">
